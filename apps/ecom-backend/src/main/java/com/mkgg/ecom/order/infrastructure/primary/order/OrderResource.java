...
import com.mkgg.ecom.order.application.OrderApplicationService;
import com.mkgg.ecom.order.domain.order.CartPaymentException;
import com.mkgg.ecom.order.domain.order.aggregate.*;
import com.mkgg.ecom.order.domain.order.vo.StripeSessionId;
import com.mkgg.ecom.order.domain.user.vo.*;
...
import static com.mkgg.ecom.product.infrastructure.primary.ProductsAdminResource.ROLE_ADMIN;
