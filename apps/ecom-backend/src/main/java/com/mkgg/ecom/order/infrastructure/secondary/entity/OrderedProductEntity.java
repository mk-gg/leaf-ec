package com.mkgg.ecom.order.infrastructure.secondary.entity;

import com.mkgg.ecom.order.domain.order.aggregate.OrderedProduct;
import com.mkgg.ecom.order.domain.order.aggregate.OrderedProductBuilder;
import com.mkgg.ecom.order.domain.order.vo.OrderPrice;
import com.mkgg.ecom.order.domain.order.vo.OrderQuantity;
import com.mkgg.ecom.order.domain.order.vo.ProductPublicId;
import com.mkgg.ecom.product.domain.vo.ProductName;
