package com.mkgg.ecom.order.application;

import com.mkgg.ecom.order.domain.order.aggregate.*;
import com.mkgg.ecom.order.domain.order.repository.OrderRepository;
import com.mkgg.ecom.order.domain.order.service.CartReader;
import com.mkgg.ecom.order.domain.order.service.OrderCreator;
import com.mkgg.ecom.order.domain.order.service.OrderReader;
import com.mkgg.ecom.order.domain.order.service.OrderUpdater;
...
import com.mkgg.ecom.product.application.ProductsApplicationService;
